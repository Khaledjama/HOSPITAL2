...
namespace HOSPITAL2.Controllers
{
    ...
    public class AspNetUserRolesController : Controller
    {
        ...
        public ActionResult Details(string id)
        {
            ...
            AspNetUserRoles aspNetUserRole = db.AspNetUserRoles.Find(id);
        ...
        public ActionResult Create([Bind(Include = "UserId,RoleId,content")] AspNetUserRoles aspNetUserRole)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UserId,RoleId,content")] AspNetUserRoles aspNetUserRole)
        {
            if (ModelState.IsValid)
            {
